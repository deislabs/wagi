...
use crate::{
    ...
    wagi_config::{HandlerConfigurationSource, PreHandlerConfiguration, WagiConfiguration},
};
...
impl Emplacer {
    ...
    async fn emplace_standalone_bindle(
        ...
        id: &bindle::Id,
    ) -> anyhow::Result<PreHandlerConfiguration> {
...
mod test {
    ...
    async fn can_emplace_standalone_bindle() {
        let test_id =
            bindle::Id::from_str("itowlson/toast-on-demand/0.1.0-ivan-2021.09.24.17.06.16.069")
        ...
        assert!(
            asset_cache_dir
                .join("_ASSETS/5c168e0e969ec344be4044dccd4f68e26f20976a5edac0d49e0c28c57ba465b5")
                .is_dir(),
